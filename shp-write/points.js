(function (root, factory) {
  if(typeof define === "function" && define.amd) {
    define(['./extent'], factory);
  } else if(typeof module === "object" && module.exports) {
    module.exports = factory(require('./extent'));
  } else {
    root.test = factory();
  }
}(this, function(ext) {
  ...
  var pointsMod = {
    write: function(coordinates, extent, shpView, shxView) {
      this.writePoints(coordinates, extent, shpView, shxView);
    },
    writePoints: function(coordinates, extent, shpView, shxView) {
      var contentLength = 28, // 8 header, 20 content
          fileLength = 100,
          shpI = 0,
          shxI = 0;

      coordinates.forEach(this.writePoint(coords, i));
    },
    writePoint: function(coords, i) {
      // HEADER
      // 4 record number
